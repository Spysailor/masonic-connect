...
const PricingCard = ({ title, price, features, buttonText, featured = false, to }) => (
  <motion.div 
    className={cn(
      "p-6 rounded-lg border-2 h-full flex flex-col",
    ...
    <Link 
      ...
      className={cn(
        ...
        featured 
          ...
          : 'border border-masonic-blue-700 text-masonic-blue-700 hover:bg-masonic-blue-50'
      )}
    >
      {buttonText}
    </Link>
